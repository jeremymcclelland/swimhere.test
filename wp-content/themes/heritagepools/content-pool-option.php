...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		<div class="entry-content-thumbnail hidden-sm hidden-md hidden-lg">
			<img class="img-responsive member-photo" alt="<?php the_title(); ?> - Heritage Pools, LLC" title="<?php the_title(); ?> - Heritage Pools, LLC" src="<?php echo $pool_option_image_small; ?>"/>
		</div>

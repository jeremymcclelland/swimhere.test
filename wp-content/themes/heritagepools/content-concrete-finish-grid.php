...
?>
						...
						<?php
							...
							$terms = get_the_terms(get_the_ID(), 'finish-type');
		        ...
		        <div id="post-<?php the_ID(); ?>" class="text-center match-height media-box <?php echo $term_classes; ?>">
		            ...
		            <div class="media-box-image">
		                <div data-title="<?php the_title(); ?> - Concrete Finish" data-alt="<?php the_title(); ?> - Concrete Finish" data-width="500px" data-height="500px" data-thumbnail="<?php echo $pool_option_thumb; ?>"></div>

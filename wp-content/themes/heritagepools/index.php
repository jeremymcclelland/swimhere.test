...
/*
$highlights = get_terms( array(
    'taxonomy' => 'pool-highlight',
    'hide_empty' => true,
) );
...
foreach($highlights as $highlight){
	$filter_options .= '<li><a href="#" data-filter=".' . $highlight->slug . ' ">' . $highlight->name . '</a></li>';
}
*/
...
-->
            ...
            <div class="media-boxes-drop-down">
                ...
                <ul class="media-boxes-drop-down-menu filters" data-id="first-filter">
                  <li><a class="selected" href="#" data-filter="*">All Categories</a></li>

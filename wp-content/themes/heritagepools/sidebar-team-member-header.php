...
$image = get_field('team_member_header_image');
if(!$image){
...
$overlay = get_field('team_member_overlay_color');
$opacity = get_field('team_member_overlay_transparency');

$rgba = hex2rgba($overlay, $opacity);
$background = 'style="background-color: ' . $rgba . ';"';

$text_color = get_field('team_member_header_text_color');
$divider_color = get_field('team_member_header_divider_color');
$shadow = get_field('team_member_add_text_shadow');

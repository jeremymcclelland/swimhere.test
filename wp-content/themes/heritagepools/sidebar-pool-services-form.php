...
?>
	...
	<div class="sidebar col-sm-12 col-md-4">
		...
		<a class="btn btn-block btn-orange-general sidebar-btn hidden-sm hidden-md hidden-lg" href="<?php get_site_url(); ?>/our-services/other-pool-services/">View All Services</a>	

...
$overlay = get_field('page_overlay_color');
$opacity = get_field('page_overlay_transparency');
...
$text_color = get_field('page_header_text_color');
$divider_color = get_field('page_header_divider_color');
$shadow = get_field('page_add_text_shadow');
...
$title_override = get_field('page_header_title_override');
$sub_title = get_field('page_header_subtitle');

if(!$title_override){
	
	$title_override = get_the_title();
	
}

$position = get_field('page_header_image_position');
if(!$position){
	$position = 'center';
}
...
<!-- data-parallax="scroll" data-image-src="<?php echo $image; ?>" -->
<div class="flex-header text-center" style="background-image: url('<?php echo $image; ?>'); background-position: center <?php echo $position; ?>; background-size: cover;">

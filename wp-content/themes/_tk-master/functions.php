...
add_image_size( 'media-box-thumb', 500, 400, true);
...
function _tk_scripts() {
	...
	// load bootstrap css
	//wp_enqueue_style( '_tk-bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css' );
	wp_enqueue_style( '_tk-bootstrap', THEME_DIR_URI . '/includes/css/bootstrap.min.css', false, '4.1.0' );
	...
	// load bootstrap js
	//wp_enqueue_script('_tk-bootstrapjs', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js', array('jquery') );

...
function _tk_content_nav( $nav_id ) {
	...
	<nav role="navigation" id="<?php echo esc_attr( $nav_id ); ?>" class="<?php echo $nav_class; ?>">
		...
		<?php if ( is_single() ) : // navigation links for single posts ?>
			...
			<?php previous_post_link( '<li class="nav-previous previous">%link</li>', '<span class="meta-nav">' . _x( '<i class="fa fa-arrow-left"></i>', 'Previous post link', '_tk' ) . '</span> Previous' ); ?>
			<?php next_post_link( '<li class="nav-next next">%link</li>', 'Next <span class="meta-nav">' . _x( '<i class="fa fa-arrow-right"></i>', 'Next post link', '_tk' ) . '</span>' ); ?>
...
function _tk_posted_on() {
	...
	printf( __( '<span class="Xposted-on">%1$s</span>', '_tk' ),
		$time_string,
		sprintf( '<span class="x">%3$s</span>',
...
<div class="text-center">
    <nav>
        <ul class="pagination">
            ...
            <li>
                <form method="get" id="tk-pagination" class="tk-page-nav hidden">
